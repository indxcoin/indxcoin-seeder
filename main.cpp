...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "indxcoin-seeder\n"
...
static const string mainnet_seeds[] = {"seeder1.indxcoin.network", "seeder2.indxcoin.network", "seeder3.indxcoin.network",  "seeder4.indxcoin.network", ""};
static const string testnet_seeds[] = {"testnet-seed01.indxcoin.network", "testnet-seed02.indxcoin.network", "testnet-seed03.indxcoin.network",  ""};
